...
interface QuarterSelectionProps {
  value: Quarter;
  onChange: React.Dispatch<React.SetStateAction<Quarter>>;
}

export default function QuarterSelection({ value = "year", onChange }: QuarterSelectionProps) {
  return (
      ...
      {QUARTER_OPTIONS.map((opt) => {
        ...
        return (
          <Card
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter" || e.key === " ") onChange(opt.key);
            }}
            className={cn(
